...
\newcommand{\figGammaCorrection}{%
\stdFigure{fig:gamma_correction}{figures/enhance_1_gamma.png}{Image enhancement from normal to Gamma correction}
}

\newcommand{\figCLAHE}{%
\stdFigure{fig: clahe}{figures/enhance_2_clahe.png}{Image enhancement from normal to CLAHE}
}

\newcommand{\figUnsharp}{%
\stdFigure{fig: unsharp}{figures/enhance_3_unsharp.png}{Image enhancement from normal to unsharp}
}

\newcommand{\figViolationEx}{%
\stdFigure{fig: violation_ex}{figures/violation.png}{Violation detection example.}
}
